...
/************************************************************************/
/* Cryptography Function : Using Openssl for website */
/* ============================================                         */
/* Write by Kaos Chuks                                                */
...
if(!is_file("LibCrypt.php" || "LibCrypt.php"))
{
    require_once "LibCrypt.php";
    require_once "ICrypt.php";
}

class Crypto extends Unsafe implements ICrypt
{
